...
const scienceGames: Record<string, GameData> = {
  'science-1': {
    type: 'weather',
    items: [
      { name: 'Sunny', icon: '☀️', description: 'Bright and warm day', sound: 'chirp chirp' },
      { name: 'Rainy', icon: '🌧️', description: 'Water falls from clouds', sound: 'pitter patter' },
      { name: 'Cloudy', icon: '☁️', description: 'Sky covered with clouds', sound: 'whoosh' },
      { name: 'Snowy', icon: '❄️', description: 'Cold with falling snow', sound: 'crunch crunch' },
    ],
    questions: [
  ...
  'science-4': {
    ...
    stages: [
      ...
      { name: 'Sprout', icon: '🌱', description: 'Seed grows roots and a small shoot' },
      { name: 'Seedling', icon: '🌿', description: 'Young plant with leaves' },
      { name: 'Adult Plant', icon: '🌻', description: 'Fully grown with flowers' },
    ],
