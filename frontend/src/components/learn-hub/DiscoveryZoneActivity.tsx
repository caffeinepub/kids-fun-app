...
const discoveryGames: Record<string, GameData> = {
  'discovery-1': {
    type: 'facts',
    facts: [
      { fact: 'Honey never spoils! Archaeologists found 3000-year-old honey that was still good!', emoji: '🍯', quiz: 'How old was the honey found?', answer: '3000 years' },
      { fact: 'A group of flamingos is called a "flamboyance"!', emoji: '🦩', quiz: 'What is a group of flamingos called?', answer: 'flamboyance' },
      { fact: 'Octopuses have three hearts!', emoji: '🐙', quiz: 'How many hearts does an octopus have?', answer: '3' },
      { fact: 'Bananas are berries, but strawberries are not!', emoji: '🍌', quiz: 'Are bananas berries?', answer: 'yes' },
    ],
  },
  'discovery-2': {
    type: 'how-it-works',
    items: [
      { name: 'Light Bulb', emoji: '💡', steps: ['Electricity flows through wire', 'Wire heats up and glows', 'Light shines bright!'] },
      { name: 'Bicycle', emoji: '🚲', steps: ['Pedals turn the chain', 'Chain moves the wheels', 'Wheels roll forward!'] },
      { name: 'Rainbow', emoji: '🌈', steps: ['Sunlight hits water drops', 'Light splits into colors', 'Colors appear in the sky!'] },
    ],
  },
  'discovery-3': {
    type: 'world-explorer',
    countries: [
      { name: 'Egypt', emoji: '🇪🇬', landmark: '🏛️ Pyramids', fact: 'Home to ancient pyramids' },
      { name: 'Japan', emoji: '🇯🇵', landmark: '🗾 Mount Fuji', fact: 'Land of the rising sun' },
      { name: 'Brazil', emoji: '🇧🇷', landmark: '🌴 Amazon Rainforest', fact: 'Has the biggest rainforest' },
      { name: 'France', emoji: '🇫🇷', landmark: '🗼 Eiffel Tower', fact: 'Famous for the Eiffel Tower' },
    ],
  },
  'discovery-4': {
    type: 'inventions',
    inventions: [
      { name: 'Wheel', emoji: '⚙️', year: '3500 BC', impact: 'Made transportation easier', inventor: 'Ancient Mesopotamians' },
      { name: 'Light Bulb', emoji: '💡', year: '1879', impact: 'Brought light to homes', inventor: 'Thomas Edison' },
      { name: 'Airplane', emoji: '✈️', year: '1903', impact: 'Enabled air travel', inventor: 'Wright Brothers' },
    ],
  },
};
