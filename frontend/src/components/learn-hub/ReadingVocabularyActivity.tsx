...
const wordGames: Record<string, GameData> = {
  ...
  'reading-5': {
    type: 'vocabulary',
    words: [
      { word: 'happy', meaning: 'feeling joy and pleasure', image: '😊', sentence: 'I am happy when I play.' },
      { word: 'big', meaning: 'large in size', image: '🐘', sentence: 'The elephant is big.' },
      { word: 'fast', meaning: 'moving quickly', image: '🏃', sentence: 'The rabbit runs fast.' },
      { word: 'bright', meaning: 'giving out light', image: '💡', sentence: 'The sun is bright.' },
    ],
  },
};
