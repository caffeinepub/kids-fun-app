...
import { ArrowLeft, ExternalLink, Video, Play, Sparkles } from 'lucide-react';
...
export default function VideoHubPage() {
  ...
  const [selectedChannel, setSelectedChannel] = useState<VideoChannelData | null>(null);
  const [selectedCraft, setSelectedCraft] = useState<typeof craftDiyProjects[0] | null>(null);
            ...
            <CardContent className="p-6 space-y-4">
              <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-yellow-800">
                  Follow the step-by-step instructions in the Craft & DIY section to complete this project!
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-purple-900 mb-2">About This Craft</h3>
                <p className="text-gray-700 mb-2">
                  <strong>Materials:</strong> {selectedCraft.materials.join(', ')}
                </p>
                <p className="text-gray-700">
                  <strong>Steps:</strong> {selectedCraft.steps.length} step-by-step instructions
                </p>
              </div>
              ...
              {selectedChannel.embedAllowed ? (
                <>
                  ...
                  <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4">
                    <p className="text-sm text-blue-900 mb-3">
                      <strong>Safe Viewing:</strong> Videos are embedded from YouTube with enhanced privacy settings.
                    </p>
                    <Button
                      asChild
                      variant="outline"
                ...
                <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6 text-center">
                  ...
                  <p className="text-yellow-900 mb-4">
                    This channel's videos cannot be embedded, but you can watch them directly on YouTube!
                  </p>
                  <Button
                    asChild
                    className="w-full"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'channels' | 'crafts')} className="mb-6">
          ...
          <TabsContent value="crafts" className="space-y-6">
            <div className="text-center mb-4">
              <p className="text-gray-700">
                Explore our craft projects with detailed step-by-step instructions!
              </p>
            </div>
                ...
                >
                  ...
                  <CardContent className="p-4">
                    <p className="text-sm text-gray-600">
                      Learn how to make this {craft.category.toLowerCase()} project
                    </p>
                  </CardContent>
                </Card>
              ))}
        ...
        <div className="mt-8 bg-blue-50 border-2 border-blue-300 rounded-lg p-6 text-center">
          <p className="text-sm text-blue-900">
            <strong>Parent Note:</strong> All videos are from trusted educational channels. We recommend parental supervision for the best viewing experience.
          </p>
        </div>
      </div>
    </div>
