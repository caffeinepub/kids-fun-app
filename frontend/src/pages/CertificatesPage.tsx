...
export default function CertificatesPage() {
  ...
  const generateCertificateCanvas = (canvas: HTMLCanvasElement, _forDownload: boolean = false) => {
  ...
  const downloadPDF = async (cert: { id: string; achievement: string; date: number; userId: string }) => {
    try {
              ...
              <div className="border-4 border-dashed border-yellow-400 rounded-lg p-8 bg-white">
                <div className="text-center space-y-4">
                  ...
                  <div className="border-t-2 border-b-2 border-yellow-400 py-4">
                    ...
                    <p className="text-2xl font-bold text-purple-600 my-2">{userName || 'Your Name'}</p>
                  ...
                  <Card key={cert.id} className="border-2 hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between">
                        ...
                        <Button size="sm" variant="outline" onClick={() => downloadPDF(cert)}>
                          <Download className="w-4 h-4 mr-2" />
                          Download
                        </Button>
                      </div>
