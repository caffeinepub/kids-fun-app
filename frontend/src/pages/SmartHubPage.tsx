...
import { Sparkles, Star, Clock, TrendingUp, Zap } from 'lucide-react';
...
const ALL_ACTIVITIES: RecommendedActivity[] = [
  { id: 'games', title: 'Games Hub', description: 'Play exciting games and earn trophies!', icon: '🎮', page: 'games', difficulty: 'medium', tags: ['fun', 'games', 'trophies'] },
  { id: 'learn-hub', title: 'Learn Hub', description: 'Explore educational activities', icon: '📚', page: 'learn-hub', difficulty: 'easy', tags: ['learning', 'education'] },
  { id: 'virtual-pet', title: 'Virtual Pet', description: 'Care for your virtual pet', icon: '🐾', page: 'virtual-pet', difficulty: 'easy', tags: ['pet', 'care', 'fun'] },
  { id: 'spin-wheel', title: 'Spin the Wheel', description: 'Spin to win trophies and points!', icon: '🎡', page: 'spin-wheel', difficulty: 'easy', tags: ['rewards', 'fun', 'trophies'] },
  { id: 'story-builder', title: 'Story Builder', description: 'Create your own stories', icon: '📖', page: 'story-builder', difficulty: 'medium', tags: ['creative', 'stories'] },
  { id: 'art-gallery', title: 'Art Gallery', description: 'Share your artwork', icon: '🎨', page: 'art-gallery', difficulty: 'easy', tags: ['art', 'creative'] },
  { id: 'music-remix', title: 'Music Remix', description: 'Create music remixes', icon: '🎵', page: 'music-remix', difficulty: 'medium', tags: ['music', 'creative'] },
  { id: 'sticker-creator', title: 'Sticker Creator', description: 'Design custom stickers', icon: '🌟', page: 'sticker-creator', difficulty: 'easy', tags: ['creative', 'art'] },
  { id: 'craft-diy', title: 'Craft & DIY', description: 'Fun craft projects', icon: '✂️', page: 'craft-diy', difficulty: 'medium', tags: ['craft', 'creative'] },
  { id: 'scary-hub', title: 'Scary Hub', description: 'Spooky Halloween games', icon: '👻', page: 'scary-hub', difficulty: 'medium', tags: ['scary', 'games', 'halloween'] },
];
...
export default function SmartHubPage() {
  ...
  useEffect(() => {
    ...
    const recs = ALL_ACTIVITIES.filter((_, i) => i !== dayIndex % ALL_ACTIVITIES.length).slice(0, 6);
  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-700">Your personalized activity center</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="border-4 bg-gradient-to-br from-blue-50 to-purple-50 text-center">
          <CardContent className="pt-4">
            <p className="text-3xl font-bold text-blue-600">{gameStates.length}</p>
        ...
        <Card className="border-4 bg-gradient-to-br from-pink-50 to-red-50 text-center">
          <CardContent className="pt-4">
            <p className="text-3xl font-bold text-pink-600">{recentlyPlayed.length}</p>
      ...
      {dailyPick && (
        <Card className="border-4 border-yellow-400 bg-gradient-to-br from-yellow-50 to-orange-50 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Today's recommended activity just for you!</CardDescription>
          </CardHeader>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {recentlyPlayed.slice(0, 8).map((item) => (
              <Card key={item.id} className="border-2 hover:shadow-md transition-shadow cursor-pointer">
