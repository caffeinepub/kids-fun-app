...
export default function SeasonalEventsPage() {
  ...
  return (
    <div className="space-y-6">
                  ...
                  <Card key={story.id} className="p-4 border-2 hover:shadow-lg transition-all">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-3">{story.genre}</p>
                        <Button onClick={() => handleStoryRead(story)} size="sm">
                          Read Story
                        </Button>
                      </div>
                    </div>
      ...
      <Dialog open={!!selectedStory} onOpenChange={(open) => !open && handleCloseStory()}>
