    ...
    const gameLoop = () => {
      ...
      if (isPaused) {
        ...
        state.pauseEffects.forEach((effect, idx) => {
          ...
          const effectText = effect.type === 'spawn' ? '⚠️ Spawning hazard!' :
                            effect.type === 'rewind' ? '⏪ Rewinding time!' :
                            '🌀 Teleporting!';
    ...
    >
      <div className="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-gray-900 to-indigo-900">
        <div className="mb-4 text-center text-white">
          ...
          <p className="text-sm">Arrow keys/WASD to move • Press P to pause • Watch what happens!</p>
        </div>
        <canvas
          ref={canvasRef}
          width={800}
