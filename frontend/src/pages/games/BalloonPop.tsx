      ...
      >
        ...
        {showInstructions && !gameOver && timeLeft === 60 && (
          <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
            <div className="bg-white p-8 rounded-lg border-4 border-purple-300 text-center shadow-xl max-w-md pointer-events-auto">
              ...
              <p className="text-lg mb-2">🎈 Normal Balloons: <span className="font-bold text-green-600">+10 points</span></p>
              <p className="text-lg mb-2">⭐ Gold Balloons: <span className="font-bold text-yellow-600">+20 points</span></p>
              <p className="text-lg mb-4">💣 Dark Balloons: <span className="font-bold text-red-600">-5 points</span></p>
        ...
        {balloonsRef.current.map(balloon => (
          ...
          >
            ...
            >
              {balloon.type === 'bonus' && (
                <div className="text-2xl text-center absolute inset-0 flex items-center justify-center pointer-events-none select-none">⭐</div>
              )}
