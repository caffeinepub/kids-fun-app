        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Card className="border-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={handleSave} disabled={saveStoryMutation.isPending} className="flex-1">
            ...
            <TabsContent value="props" className="mt-4">
              <Card className="border-4">
                ...
                <CardContent>
                  ...
                  <Button onClick={addTextBubble} className="w-full mt-4" variant="outline">
                    💬 Add Text Bubble
                  </Button>
                </CardContent>
              </Card>
                    ...
                    myStories.map((story) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-gray-500">{story.scenes.length} scenes</p>
                        </div>
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="flex gap-2 justify-center mt-4">
            <Button onClick={previousPreviewScene} disabled={previewScene === 0} variant="outline">
              ← Previous
            </Button>
