...
import { craftDiyProjects, CraftProjectData } from '@/content/craftDiyProjects';
...
export default function CraftDIYPage() {
  ...
  const [selectedProject, setSelectedProject] = useState<CraftProjectData | null>(null);
            ...
            >
              ...
              <CardContent className="p-4">
                <p className="text-sm text-gray-600 mb-3">
                  {project.steps.length} steps • {project.materials.length} materials
                </p>
